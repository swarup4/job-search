...
| `server/` — REST API, local MongoDB | **built** — eight modules, fifteen collections, 57 endpoints over 51 paths, Beanie over local MongoDB. **No tests** (removed on request), so no story is Done per Roadmap §10 |
